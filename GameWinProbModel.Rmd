...
# XGBoost Model 
```{r}
march_model <- xgboost(data = matrix_march_training, label = as.matrix(training_labels), max.depth = 2, eta = 0.3, nthread = 2, nrounds = 646, model = "binary:logistic")
...
```{r}
march_training <- march[,c("T1adjoe", "T1conf", "T1adjde", "T1sos", "T1ncsos", "T1consos", "T1Opp.OE", "T1Opp.DE", "T1Con.Adj.OE", "T1Con.Adj.DE","T1winRate", "T1eFG", "T1eFG..Def", "T1FTR.Def", "T1TO", "T1TO..Def", "T13P", "T13pD.", "T1ft", "T12p.D", "T1ft", "T1ft.D", "T13P.rate", "T13P.rate.D", "T1arate", "T1arateD")]
```
